module.exports = {
	...
	adminId: "964528942117711912", //- Replace UserId with the Discord ID of the admin of the bot
	token: process.env.token || "6dbf924b158f15f4abfcd04e8fbbf4f7a0dbbf869eb648fcac2c249105cacfb7", //- Bot's Token
	clientId: process.env.clientId || "1214537309937209405", //- ID of the bot
	clientSecret: process.env.clientSecret || "JPTdxiRcEcRZIqky8D5zZFCtXThwNDT7", //- Client Secret of the bot
